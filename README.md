...
P1 model=Normal wins=389 avg_diff=-9.204 reason_7plus=1428 reason_opponent_koikoi=809 koikoi=4036 koikoi_success=2545 koikoi_success_rate=63.06%
CPU model=Hard wins=608 avg_diff=9.204 reason_7plus=1609 reason_opponent_koikoi=1300 koikoi=2693 koikoi_success=1799 koikoi_success_rate=66.80%
DRAW draws=3
Sake round summary: 1P=2043, CPU=1995
 - 1P detail: win=978 (47.87%), average=9.91pts koikoi-cnt=999 koikoi-win=643 koikoi-up=7.95pts
 - CPU detail: win=1226 (61.45%), average=10.07pts koikoi-cnt=894 koikoi-win=612 koikoi-up=9.72pts
KOIKOI_BASE6_PUSH P1=0/0/0 CPU=118/118/6
KOIKOI_LOCKED_THRESHOLD P1=0/0 CPU=6/1
WIN_RATE P1=38.90%(59.69pts) CPU=60.80%(60.57pts)
- Round 1: P1=42.20%(7.88pts) CPU=53.80%(7.74pts)
- Round 2: P1=40.70%(8.32pts) CPU=55.30%(7.20pts)
- Round 3: P1=39.10%(7.85pts) CPU=56.40%(7.37pts)
- Round 4: P1=43.50%(8.10pts) CPU=52.30%(7.56pts)
- Round 5: P1=43.00%(7.62pts) CPU=52.90%(7.67pts)
- Round 6: P1=42.00%(7.85pts) CPU=53.70%(7.91pts)
- Round 7: P1=40.80%(8.16pts) CPU=55.20%(7.49pts)
- Round 8: P1=40.80%(7.40pts) CPU=55.10%(7.09pts)
- Round 9: P1=42.30%(7.15pts) CPU=53.80%(7.54pts)
- Round 10: P1=43.20%(7.93pts) CPU=52.30%(6.69pts)
- Round 11: P1=42.90%(7.77pts) CPU=54.10%(7.94pts)
- Round 12: P1=43.00%(6.92pts) CPU=52.80%(7.06pts)
Per Bias:
- GREEDY: win=1876 (63.4%), lose=1013 (34.2%), draw=72 (2.4%)
- DEFENSIVE: win=3924 (48.5%), lose=3780 (46.7%), draw=392 (4.8%)
- BALANCED: win=677 (71.8%), lose=242 (25.7%), draw=24 (2.5%)
```

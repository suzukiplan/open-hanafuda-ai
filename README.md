...
KOIKOI_BASE6_PUSH P1=0/0/0 CPU=140/140/12
KOIKOI_LOCKED_THRESHOLD P1=0/0 CPU=6/1
WIN_RATE P1=37.40%(57.49pts) CPU=62.10%(60.00pts)
- Round 1: P1=39.90%(7.73pts) CPU=56.10%(7.60pts)
- Round 2: P1=38.70%(8.16pts) CPU=57.40%(6.86pts)
- Round 3: P1=37.80%(7.99pts) CPU=57.90%(7.30pts)
- Round 4: P1=41.40%(7.74pts) CPU=54.60%(7.47pts)
- Round 5: P1=40.00%(7.38pts) CPU=56.40%(7.51pts)
- Round 6: P1=41.20%(7.74pts) CPU=54.70%(7.43pts)
- Round 7: P1=39.00%(8.29pts) CPU=56.90%(6.81pts)
- Round 8: P1=40.00%(7.58pts) CPU=56.20%(7.26pts)
- Round 9: P1=40.50%(7.27pts) CPU=56.70%(6.91pts)
- Round 10: P1=40.80%(7.80pts) CPU=55.50%(6.86pts)
- Round 11: P1=41.00%(7.72pts) CPU=55.80%(7.63pts)
- Round 12: P1=42.70%(7.01pts) CPU=53.20%(6.73pts)
Per Bias:
- GREEDY: win=1864 (66.9%), lose=872 (31.3%), draw=49 (1.8%)
- DEFENSIVE: win=4086 (49.8%), lose=3737 (45.5%), draw=389 (4.7%)
- BALANCED: win=764 (76.2%), lose=221 (22.0%), draw=18 (1.8%)
```

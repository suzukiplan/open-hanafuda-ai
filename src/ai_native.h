...
#define OUT_PLAY_LOG_ADDR 0xE80058
#define OUT_PLAY_LOG_CONTROL 0xE8005C
...
enum PLAY_LOG_COMMAND {
    PLAY_LOG_COMMAND_WRITE = 1,
    PLAY_LOG_COMMAND_BEGIN = 2,
    PLAY_LOG_COMMAND_FLUSH_ROUND = 3,
    PLAY_LOG_COMMAND_END = 4,
};
